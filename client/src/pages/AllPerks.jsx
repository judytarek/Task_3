...
export default function AllPerks() {
  ...
  /*** useEffect #1 — Load all perks initially ***/
  useEffect(() => {
    loadAllPerks()
  }, [])

  /*** useEffect #2 — Auto-search whenever inputs change (debounced) ***/
  useEffect(() => {
    const t = setTimeout(() => {
      loadAllPerks()
    }, 350)
  ...
  // Recompute unique merchants whenever perks change
  useEffect(() => {
